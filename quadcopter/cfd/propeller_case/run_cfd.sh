...
surfaceTransformPoints -scale "(0.001 0.001 0.001)" constant/triSurface/propeller.stl constant/triSurface/propeller_scaled.stl
mv constant/triSurface/propeller_scaled.stl constant/triSurface/propeller.stl
